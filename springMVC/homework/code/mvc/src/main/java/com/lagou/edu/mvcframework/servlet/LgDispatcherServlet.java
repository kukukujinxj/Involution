        ...
        for (Map.Entry<String, Object> entry : ioc.entrySet()) {
            ...
            for (int i = 0; i < methods.length; i++) {
                ...
                if (method.isAnnotationPresent(Security.class)) {
                    ...
                    userNameSet = new HashSet<>(Arrays.asList(value));
                } else {
...
//        method.invoke() //
    ...
    private Handler getHandler(HttpServletRequest req) throws Exception {
        ...
        for (Handler handler : handlerMapping) {
            ...
            checkSecurity(handler, req.getQueryString());
            return handler;
        }
    ...
    private void checkSecurity(Handler handler, String queryString) throws Exception {
        Set<String> userNameSet = handler.getUserNameSet();
        //该类或者方法没有加@Sercurity
